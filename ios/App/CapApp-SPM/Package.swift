...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "DanieleRolliCapacitorScopedStorage", path: "../../../node_modules/@daniele-rolli/capacitor-scoped-storage")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
            dependencies: [
                ...
                .product(name: "DanieleRolliCapacitorScopedStorage", package: "DanieleRolliCapacitorScopedStorage")
            ]
        )
    ]
)
